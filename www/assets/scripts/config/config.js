module.exports = {
  APP_NAME: 'myApp',
  ROOM_COLORS: ['#cc0000', '#cc6600', '#cbcc00', '#64cc00', '#00cc00', '#00cc66', '#00cbcc', '#0064cc', '#0000cc', '#6600cc', '#cc00cb', '#cc0064'],
  APPLIANCE_TYPES: [
    {
      "id": "air_conditioner", 
      "wattage": 1000,
    ...
    {
      "id": "coffee_maker:_percolater_brew",
      "wattage": 600,
      "standby_wattage": 0,
    ...
    {
      "id": "coffee_maker:_percolater_warm",
      "wattage": 80,
      "standby_wattage": 0,
    ...
    {
      "id": "electronic_air_cleanerfilter",
      "wattage": 50,
      "standby_wattage": 0,
    ...
    {
      "id": "home_facsimile_machines_thermal",
      "wattage": 175,
      "standby_wattage": 30,
    ...
    {
      "id": "home_faxmulti_function_device_inkjet",
      "wattage": 18,
      "standby_wattage": 8,
    ...
    {
      "id": "irrigationpondwaterfall_circulation_pump_[1]",
      "wattage": 150,
      "standby_wattage": 0,
    ...
    {
      "id": "satellite_stations_standby_losses",
      "wattage": 25,
      "standby_wattage": 15,
